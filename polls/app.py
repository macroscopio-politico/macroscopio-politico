...
dash_app = dash.Dash(__name__, sharing=True, server=server, url_base_pathname='/dash/polls')
...
def polls_chart_change(year, x_axes, y_axes, bubble_size, grouping, regional_aggregation, political_aggregation):
    return update(str(year), x_axes=x_axes, y_axes=y_axes, bubble_size=bubble_size,
                  grouping=grouping, regional_aggregation=regional_aggregation,
